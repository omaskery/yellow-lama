...
namespace utils
{
    namespace json
    {
        ...
        {
        public:
            Exception(const std::string &_error) : std::runtime_error(_error) {}
            Exception(const char *_error) : std::runtime_error(_error) {}
        };
        ...
        public:
            ...
            inline Object(const List &_list)
                : m_Type(type::List), m_Elements(_list)
            {
            }
            ...
            void serialise(std::ostream &_stream, int _indent = 0, bool _short = false) const;
            ...
            inline std::string toStringShort() const {
                std::stringstream result;
                serialise(result, 0, true);
                return result.str();
            }
        ...
        private:
            ...
            void checkTypes(const std::vector<type::Type> &_types) const
            {
                ...
                throw Exception("json type mismatch");
            }
